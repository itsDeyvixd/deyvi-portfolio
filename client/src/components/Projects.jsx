      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p style={{ color: '#C8372D' }} className="text-xs tracking-[0.35em] uppercase mb-3 flex items-center gap-3">
            <span style={{ color: 'rgba(245,240,235,0.1)' }} className="font-bebas text-2xl">02</span>
            Projects
          </p>
          <h2 style={{ color: '#F5F0EB' }} className="font-bebas text-6xl md:text-7xl leading-none tracking-tight">
            SELECTED<br />WORK
          </h2>
        </motion.div>
        ...
        <div style={{ gap: '1px', backgroundColor: 'rgba(255,255,255,0.05)' }} className="grid md:grid-cols-2">
          {projects.map((p, i) => (
            <motion.a
              ...
              className="group p-8"
            >
              <div style={{ color: 'rgba(255,255,255,0.08)' }} className="font-bebas text-3xl mb-4">{p.num}</div>

              <div className="flex items-start justify-between mb-3">
                <h3 style={{ color: '#F5F0EB' }} className="font-bebas text-2xl tracking-wide">
                  {p.name}
                </h3>
                {p.status === 'live' && (
          ...
          <div style={{ backgroundColor: '#0D0D0D', border: '1px solid rgba(255,255,255,0.05)' }}
            ...
            <div className="text-center">
              <div style={{ color: 'rgba(255,255,255,0.04)' }} className="font-bebas text-5xl">004</div>
